...
| 12. | Social Categories | [_hasRaceorColor_](https://lod.enslaved.org/wiki/Property:P32) is used to model racial characteristics. This property causes discussion as categorisation/expression of enslaved in Africa and the Indian Ocean world is often also based on religion, caste, class, etc. | **no** |
